...
Generated: 2026-07-16 17:02 IST
Scorer model (production sweep model): claude-sonnet-5
...
| Bucket | Count | Share |
|---|---|---|
| not flagged | 57 | 95% (57/60) |
| <0.60 | 0 | 0% (0/60) |
| 0.60-0.84 | 1 | 2% (1/60) |
| 0.85-0.89 | 1 | 2% (1/60) |
| 0.90-1.00 | 1 | 2% (1/60) |

Tier assignment: auto 3% (2/60), pending 2% (1/60), ignore 95% (57/60).

## Judge labels

good 3, bad 25, unclear 32 (of 60 scored).

## Headline metrics

| Metric | Value |
|---|---|
| **Judged-bad auto-closes the new system catches** (demoted to pending or ignored) | **100% (25/25)** |
| Judged-good auto-closes still closed automatically (>=0.85) | 0% (0/3) |
| Old single-bucket precision (judge-labeled, unclear excluded) | 11% (3/28) |
| New auto tier precision (judge-labeled, unclear excluded) | n/a |
| Estimated pending confirmations per week | ~7 |
...
|---|---|---|---|
| auto (>=0.85) | 0 | 0 | 2 |
| pending (0.60-0.85) | 0 | 1 | 0 |
| ignore (<0.60) | 3 | 24 | 30 |

Pending burden basis: last 14 days had 1269 auto-closes total, of which 853 had
...
auto-closing directly). 853/2 per week x 2% pending rate = ~7
confirmations/week.
...
- **No human ground truth.** Labels come from a single stronger-model judge
  ...
  headline numbers; "unclear" items (32) are excluded from precision.
