...
| <0.60 | 2 | 3% (2/60) |
| 0.60-0.84 | 29 | 48% (29/60) |
| 0.85-0.89 | 2 | 3% (2/60) |
| 0.90-1.00 | 13 | 22% (13/60) |

Tier assignment: auto 25% (15/60), pending 48% (29/60), ignore 27% (16/60).

## Judge labels

good 4, bad 29, unclear 27 (of 60 scored).

## Headline metrics

| Metric | Value |
|---|---|
| **Judged-bad auto-closes the new system catches** (demoted to pending or ignored) | **86% (25/29)** |
| Judged-good auto-closes still closed automatically (>=0.85) | 75% (3/4) |
| Old single-bucket precision (judge-labeled, unclear excluded) | 12% (4/33) |
| New auto tier precision (judge-labeled, unclear excluded) | 43% (3/7) |
| Estimated pending confirmations per week | ~206 |
...
auto-closing directly). 853/2 per week x 48% pending rate = ~206
confirmations/week.
...
- **No human ground truth.** Labels come from a single stronger-model judge
  ...
  headline numbers; "unclear" items (27) are excluded from precision.
